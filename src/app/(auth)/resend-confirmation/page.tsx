...
export default function ResendConfirmationPage() {
  ...
  return (
    <div className="bg-zinc-900 rounded-2xl p-8 shadow-2xl border border-zinc-800">
      <h2 className="text-xl font-semibold text-white mb-2">Resend confirmation email</h2>
      <p className="text-zinc-400 text-sm mb-6">
        Enter the email address you signed up with and we&apos;ll send a new confirmation link.
      </p>
