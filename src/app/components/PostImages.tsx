      ...
      {lightboxIndex !== null && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setLightboxIndex(null)}
              className="absolute top-3 right-3 bg-zinc-800/90 border border-zinc-600 text-white rounded-xl w-11 h-11 flex items-center justify-center hover:bg-zinc-700 transition-colors"
            >
