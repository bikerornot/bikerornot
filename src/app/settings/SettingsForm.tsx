...
export default function SettingsForm({ profile }: Props) {
  ...
  const [emailPostLikes, setEmailPostLikes] = useState(profile.email_post_likes ?? true)
    ...
    <div className="mt-10 pt-8 border-t border-zinc-800">
      ...
      <div className="space-y-3">
        {([
          ...
          { key: 'email_post_likes' as const, label: 'Someone liked your post', value: emailPostLikes, set: setEmailPostLikes },
            ...
            <button
              ...
              onClick={async () => {
                ...
                await saveEmailPreferences({
                  ...
                  email_post_likes: key === 'email_post_likes' ? next : emailPostLikes,
                })
              }}
